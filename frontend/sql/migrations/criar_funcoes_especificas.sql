-- CRIAR FUNÇÕES ESPECÍFICAS POR TABELA
-- Separar a lógica de cálculo de progresso por tipo de meta

-- 1. Remover função unificada antiga
DROP FUNCTION IF EXISTS calcular_progresso_metas() CASCADE;

-- 2. Função para calcular progresso de TERMOS AMBIENTAIS
...
-- 3. Função para calcular progresso de LVs (lv_residuos e lvs)
...
BEGIN
    ...
    IF TG_TABLE_NAME = 'lv_residuos' THEN
        data_campo := 'data_preenchimento';
...
-- 4. Função para calcular progresso de ROTINAS
