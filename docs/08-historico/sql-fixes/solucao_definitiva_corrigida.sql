-- ===================================================================
-- SOLUÇÃO DEFINITIVA CORRIGIDA: MANTER TRIGGER SEMPRE ATIVO
-- ===================================================================

-- PROBLEMA: Trigger está sendo desabilitado automaticamente
-- SOLUÇÃO: Reabilitar e criar função de monitoramento corrigida
...
2. ✅ Função de monitoramento corrigida (retorna TRIGGER)
