-- ===================================================================
-- SCRIPT SQL SIMPLES PARA INSERIR PERGUNTAS DAS LVs
...
-- Deletar perguntas existentes das LVs 02 e 03
DELETE FROM perguntas_lv WHERE codigo LIKE '02.%' OR codigo LIKE '03.%';

-- Deletar configurações existentes das LVs 02 e 03
DELETE FROM lv_configuracoes WHERE tipo_lv IN ('02', '03');

-- Deletar categorias existentes (se quiser recriar)
-- DELETE FROM categorias_lv WHERE codigo IN ('02', '03');

-- Deletar versão existente (se quiser recriar)
-- DELETE FROM versoes_lv WHERE nome = 'Revisão 09';
...
-- 4. OBTER IDs E INSERIR PERGUNTAS
-- ===================================================================
