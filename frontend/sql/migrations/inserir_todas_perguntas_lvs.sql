-- ===================================================================
-- SCRIPT SQL COMPLETO - TODAS AS PERGUNTAS DAS LVs
-- EcoField System - LVs 02, 03, 04, 05 e 06
-- ===================================================================

-- 1. VERIFICAR E INSERIR CATEGORIAS
-- ===================================================================

-- Verificar se categoria 02 (Recursos Hídricos) existe
DO $$
BEGIN
...
-- Verificar se categoria 03 (Emissões Atmosféricas) existe
DO $$
BEGIN
...
-- Limpar perguntas existentes das LVs 02, 03, 04, 05 e 06
DELETE FROM perguntas_lv WHERE codigo LIKE '02.%' OR codigo LIKE '03.%' OR codigo LIKE '04.%' OR codigo LIKE '05.%' OR codigo LIKE '06.%';

-- Limpar configurações existentes das LVs 02, 03, 04, 05 e 06
DELETE FROM lv_configuracoes WHERE tipo_lv IN ('02', '03', '04', '05', '06');
...
BEGIN
  ...
  -- 4.1 INSERIR PERGUNTAS RECURSOS HÍDRICOS (02)
  ...
  -- 4.2 INSERIR PERGUNTAS EMISSÕES ATMOSFÉRICAS (03)
  INSERT INTO perguntas_lv (codigo, pergunta, categoria_id, versao_id, ordem, obrigatoria, ativa, created_at, updated_at)
  VALUES 
  ...
  -- 4.3 INSERIR PERGUNTAS PRODUTOS QUÍMICOS (04)
  INSERT INTO perguntas_lv (codigo, pergunta, categoria_id, versao_id, ordem, obrigatoria, ativa, created_at, updated_at)
  VALUES 
  ...
  -- 4.4 INSERIR PERGUNTAS COMBOIO (05)
  INSERT INTO perguntas_lv (codigo, pergunta, categoria_id, versao_id, ordem, obrigatoria, ativa, created_at, updated_at)
  VALUES 
  ...
  -- 4.5 INSERIR PERGUNTAS GERADOR (06)
  INSERT INTO perguntas_lv (codigo, pergunta, categoria_id, versao_id, ordem, obrigatoria, ativa, created_at, updated_at)
  VALUES 
  ...
  -- 4.6 INSERIR CONFIGURAÇÕES DE LV
  ...
  RAISE NOTICE '5 configurações de LV inseridas';
...
SELECT 'CATEGORIAS' as tipo, codigo, nome, ativa FROM categorias_lv WHERE codigo IN ('02', '03', '04', '05', '06') ORDER BY codigo;

-- Verificar versão
SELECT 'VERSÃO' as tipo, nome, descricao, ativa FROM versoes_lv WHERE nome = 'Revisão 09';

-- Verificar todas as perguntas
SELECT 'PERGUNTAS' as tipo, codigo, pergunta, ordem FROM perguntas_lv WHERE codigo LIKE '02.%' OR codigo LIKE '03.%' OR codigo LIKE '04.%' OR codigo LIKE '05.%' OR codigo LIKE '06.%' ORDER BY codigo;

-- Verificar todas as configurações
SELECT 'CONFIGURAÇÕES' as tipo, tipo_lv, nome_lv, ativa FROM lv_configuracoes WHERE tipo_lv IN ('02', '03', '04', '05', '06') ORDER BY tipo_lv;

-- ===================================================================
-- RESUMO FINAL
-- ===================================================================
-- 
-- ✅ 5 categorias verificadas/inseridas (02, 03, 04, 05, 06)
-- ✅ Versão verificada/inserida  
-- ✅ 32 perguntas inseridas:
--    • 4 perguntas Recursos Hídricos (02.01 a 02.04)
--    • 4 perguntas Emissões Atmosféricas (03.01 a 03.04)
--    • 9 perguntas Produtos Químicos (04.01 a 04.09)
--    • 9 perguntas Comboio (05.01 a 05.09)
--    • 6 perguntas Gerador (06.01 a 06.06)
-- ✅ 5 configurações de LV inseridas
--
-- =================================================================== 