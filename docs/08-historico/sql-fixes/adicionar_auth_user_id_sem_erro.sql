-- ===================================================================
-- ADICIONAR auth_user_id SEM ERROS - DESABILITANDO TRIGGERS
-- ===================================================================

-- 1. DESABILITAR TRIGGERS PROBLEMÁTICOS TEMPORARIAMENTE
-- ===================================================================

-- Desabilitar triggers que podem causar conflito
ALTER TABLE lvs DISABLE TRIGGER ALL;
ALTER TABLE metas DISABLE TRIGGER ALL;
ALTER TABLE lv_residuos DISABLE TRIGGER ALL;
ALTER TABLE inspecoes_lv DISABLE TRIGGER ALL;
ALTER TABLE termos_ambientais DISABLE TRIGGER ALL;
ALTER TABLE atividades_rotina DISABLE TRIGGER ALL;

-- 2. ADICIONAR auth_user_id NA TABELA LVs
-- ===================================================================
...
-- 3. ADICIONAR auth_user_id NA TABELA METAS
-- ===================================================================
...
-- 4. ADICIONAR auth_user_id NA TABELA LV_RESIDUOS
-- ===================================================================
...
-- 5. ADICIONAR auth_user_id NA TABELA INSPECOES_LV
-- ===================================================================
...
-- 7. CRIAR TRIGGERS PARA SINCRONIZAÇÃO AUTOMÁTICA
-- ===================================================================
...
-- 8. REABILITAR TRIGGERS (EXCETO OS PROBLEMÁTICOS)
-- ===================================================================

-- Reabilitar triggers básicos (não os de progresso)
ALTER TABLE lvs ENABLE TRIGGER ALL;
ALTER TABLE metas ENABLE TRIGGER ALL;
ALTER TABLE lv_residuos ENABLE TRIGGER ALL;
ALTER TABLE inspecoes_lv ENABLE TRIGGER ALL;
